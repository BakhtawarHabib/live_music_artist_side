...
final TextStyle blacknormal14style = GoogleFonts.roboto(
  fontSize: 14.sp,
  color: Colors.black,
);
...
final TextStyle white18normalstyle = GoogleFonts.roboto(
  fontSize: 18.sp,
  color: Colors.white,
);
final TextStyle black34mediumstyle = GoogleFonts.roboto(
  fontSize: 34.sp,
  color: Colors.black,
  fontWeight: FontWeight.w500,
);
final TextStyle white34mediumstyle = GoogleFonts.roboto(
  fontSize: 34.sp,
  color: Colors.white,
  fontWeight: FontWeight.w500,
);
...
final TextStyle fingerprinthinttext = GoogleFonts.roboto(
  fontSize: 14.sp,
